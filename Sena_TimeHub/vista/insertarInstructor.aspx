<%@ Page Title="" Language="C#" MasterPageFile="~/vista/master.Master" AutoEventWireup="true" CodeBehind="insertarInstructor.aspx.cs" Inherits="Sena_TimeHub.vista.insertarInstructor" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="form-container">
        <h2 class="form-title">Registro de Instructores</h2>
        ...
        <div class="form-group">
            <asp:Button ID="btnRegistrar" runat="server" Text="Registrar" OnClick="btnRegistrar_Click" CssClass="btn-submit btn-outline-primary" />
