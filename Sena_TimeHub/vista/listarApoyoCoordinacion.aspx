<%@ Page Title="" Language="C#" MasterPageFile="~/vista/master.Master" AutoEventWireup="true" CodeBehind="listarApoyoCoordinacion.aspx.cs" Inherits="Sena_TimeHub.vista.listarApoyoCoordinacion" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    <div class="grid-container">
        <div class="grid-title">Listado de Coordinacion</div>
        <asp:GridView ID="gvAC" runat="server" AutoGenerateColumns="false" CssClass="table table-striped" OnRowCommand="gvAC_RowCommand">
            <Columns>
                <asp:TemplateField>
                    <ItemTemplate>
    ...
    function printTable() {
        var content = document.getElementById('<%= gvAC.ClientID %>').outerHTML;
        var printWindow = window.open('', '', 'height=1400,width=1600');
        printWindow.document.write('<html><head><title>Tabla de Apoyo de Coordinación:</title></head><body>');
