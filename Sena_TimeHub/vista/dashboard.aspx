<%@ Page Title="Dashboard - SenaTimeHub" Language="C#" MasterPageFile="~/vista/master.Master" AutoEventWireup="true" CodeBehind="dashboard.aspx.cs" Inherits="Sena_TimeHub.vista.dashboard" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="body" runat="server">
    ...
    <div class="container mt-5">
        ...
        <div class="mt-4">
            <h2 class="text-center" style="color: #28a745">¡Bienvenido a SenaTimeHub!</h2>
            <p class="lead text-center">
                Con SenaTimeHub,podrás gestionar de manera eficiente y en tiempo real los horarios de tus clases y actividades, mejorando la experiencia de aprendizaje de tus estudiantes. La plataforma ofrece una interfaz amigable y flexible para planificar y organizar tu jornada educativa.
            </p>
            <div class="row mt-5">
                <div class="col-md-6">
                    <h4 style="font-size:28px; color: #28a745">Características Principales</h4>
                    <ul style="font-size:20px;">
                        <li>Gestión de horarios de clases y actividades.</li>
                        <li>Planificación flexible y dinámica.</li>
                        <li>Accesibilidad desde cualquier dispositivo.</li>
                        <li>Seguimiento del progreso de los aprendices.</li>
                    </ul>
                </div>
                <div class="col-md-6">
                    <h4 style="font-size:28px;color: #28a745" class="lead text-center">¿Cómo te ayuda?</h4>
                    <p class="lead text-justify">Optimiza tus horarios, ajusta actividades a tus tiempos y mejora la interacción con tus estudiantes mediante notificaciones y actualizaciones de horarios en tiempo real. ¡Todo desde una plataforma intuitiva y fácil de usar!</p>
                </div>
            </div>
        </div>
    </div>
