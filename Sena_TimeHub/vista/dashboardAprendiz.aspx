<%@ Page Title="Vista Aprendiz" Language="C#" MasterPageFile="~/vista/master.Master" AutoEventWireup="true" CodeBehind="dashboardAprendiz.aspx.cs" Inherits="Sena_TimeHub.vista.aprendizVista" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <!-- Cargar estilos adicionales si es necesario -->
        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class=" text-center">
                        <br />
                        <h1 style="color:#28a745">¡Bienvenido, Aprendiz!</h1>
                    </div>
                    <div class="card-body">
                        <p class="lead">Nos alegra tenerte en nuestra plataforma. Aquí podrás gestionar tu tiempo de aprendizaje y mucho más.</p>
                        <p>Explora las opciones disponibles en el menú para comenzar tu experiencia de aprendizaje.</p>
                        <hr />
                        <h4>¿Qué puedes hacer?</h4>
                        <ul>
                            <li>Acceder a tus cursos.</li>
                            <li>Ver tu progreso.</li>
                            <li>Consultar materiales de estudio.</li>
                        </ul>
                    </div>
                    <div class="card-footer text-center">
                        <a href="somepage.aspx" class="btn btn-primary">Ir a tu panel de aprendiz</a>
                    </div>
                </div>
            </div>
        </div>
